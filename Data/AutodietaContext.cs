    ...
    public class AutodietaContext : DbContext
    {
        ...
        private void SeedData(ModelBuilder modelBuilder)
        {
            ...
            var recetas = new[]
            {
                ...
                new Receta { Id = 5, Nombre = "Pasta con Verduras", Descripcion = "Pasta integral con verduras al vapor", Ingredientes = "Pasta integral, brócoli, zanahoria, calabacín, aceite de oliva", TipoComida = TipoComida.Comida },
